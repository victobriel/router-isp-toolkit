...
import { HuaweiEG8145V5Driver } from '@/infra/drivers/huawei/HuaweiEG8145V5Driver/HuaweiEG8145V5Driver';
import { ZteE2320Driver } from '@/infra/drivers/zte/ZteE2320Driver/ZteE2320Driver';
import { HuaweiK562E10Driver } from '@/infra/drivers/huawei/huaweiK562E10Driver/huaweiK562E10Driver';
...
export class RouterFactory implements IRouterFactory {
  private static readonly MODELS: RouterModelDefinition[] = [
    ...
    { indicators: ['k562e', 'k562e-10'], Driver: HuaweiK562E10Driver },
  ];
