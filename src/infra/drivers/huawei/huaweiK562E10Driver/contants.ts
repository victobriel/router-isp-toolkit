export const ENDPOINT = {
  ...
  WLAN_LIST_AP: '/html/amp/common/wlan_list.asp',
  ...
  WLAN_ADVANCE_COM_API: '/html/amp/wlanadv/wlanadvance_com_api.asp',
  WLAN_ADVANCE_DEST_AP_API: '/html/amp/wlanadv/wlanadvanceDestAP_api.asp',
