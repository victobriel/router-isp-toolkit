...
import {
  ZteH3601PLoginSelectors,
  ZteH3601PSelectors as Selectors,
} from "./ZteH3601PSelectors.js";

export class ZteH3601PDriver extends BaseRouter {
  private readonly s = Selectors;
  private readonly topologyParser: ITopologySectionParser;
  protected readonly loginSelectors = ZteH3601PLoginSelectors;

  constructor(topologyParser: ITopologySectionParser) {
    super("ZTE ZXHN H3601P");
