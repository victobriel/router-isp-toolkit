/**
 * CSS selectors for the ZTE ZXHN H3601P router admin UI.
 * Used by ZteH3601PDriver for navigation and data extraction.
 */
export const ZteH3601PSelectors = {
  // Login
...
export const ZteH3601PLoginSelectors = {
  username: ZteH3601PSelectors.username,
